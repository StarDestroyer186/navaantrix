...
<head>
  ...
  <title>Navaantrix Pvt. ltd.</title>
  ...
  <!--Theme CSS -->
  <link rel="stylesheet" id="astra-theme-css-css" href="<?= base_url('assets/css/main.min.css')?>" media="all" />
  <link rel="stylesheet" id="astra-google-fonts-css"
    href="https://fonts.googleapis.com/css?family=Inter%3A400%7CPoppins%3A500%2C300i%2C300%2C400&#038;display=fallback&#038;ver=4.6.9"
    media="all" />
  <link rel="stylesheet" id="astra-menu-animation-css" href="<?= base_url('assets/css/menu-animation.min.css')?>" media="all" />
  <link rel="stylesheet" id="astra-theme-css-inline-css" href="<?= base_url('assets/css/astra-theme-css-inline.css')?>" media="all" />
  <link rel="stylesheet" id="wp-block-library-css" href="<?= base_url('assets/css/style.min.css')?>" media="all" />
  <link rel="stylesheet" href="<?= base_url('assets/css/global-styles-inline.css')?>" />
  ...
  <!--Slider CSS -->
  <link rel="stylesheet" href="<?= base_url('assets/css/slider-main.css')?>" />
  <script src="<?= base_url('assets/js/slider-main.js') ?>" defer></script>
  <!--Slider CSS -->
  ...
  <!--[if IE]>
      <script
        src="http://localhost/wp-content/themes/astra/assets/js/minified/flexibility.min.js?ver=4.6.9"
...
<body itemtype="https://schema.org/WebPage" itemscope="itemscope"
  class="home page-template-default page page-id-8 wp-custom-logo ast-desktop ast-plain-container ast-no-sidebar astra-4.6.9 ast-single-post ast-inherit-site-logo-transparent ast-theme-transparent-header ast-hfb-header">
              ...
              <div class="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                <div class="site-header-primary-section-left site-header-section ast-flex site-header-section-left">
                  <div class="ast-builder-layout-element ast-flex site-header-focus-item" data-section="title_tagline">
                    <div>
                      <span class=""><a href="<?= base_url('/') ?>" class="custom-logo-link" rel="home" aria-current="page"><img
                            width="156" height="62" src="<?= base_url('assets/images/Navaantrix_Logo.png')?>" class="custom-logo"
                            alt="Navaantrix" decoding="async" /></a></span>
                    </div>
                    <!-- .site-branding -->
                  </div>
                </div>
                        ...
                        <nav class="site-navigation ast-flex-grow-1 navigation-accessibility site-header-focus-item"
                          ...
                          <div class="main-navigation ast-inline-flex">
                            <ul id="ast-hf-menu-1"
                              ...
                              <li id="menu-item-13"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-8 current_page_item menu-item-13 current-menu-item ">
                                <a href="<?= base_url('/') ?>" aria-current="page" class="menu-link">Home</a>
                              </li>
                              <li id="menu-item-278"
                              ...
                              <li id="menu-item-277"
                                ...
                                <a href="<?= base_url('/our-team') ?>" class="menu-link">Our Team</a>
                              </li>
                  ...
                  <div class="ast-builder-layout-element ast-flex site-header-focus-item"
                    ...
                    <div class="ast-header-social-1-wrap ast-header-social-wrap">
                      <div
                        ...
                        <a href="mailto:<?= $email = get_setting('company_email'); ?>%20" aria-label="Email" style="
                              --color: #ea4335;
                              --background-color: transparent;
                            " class="ast-builder-social-element ast-inline-flex ast-email header-social-item"><span
                            ...
                            </svg></span></a><a href="tel:+91<?= $email = get_setting('company_phone'); ?>" aria-label="Call" us style="
                              --color: inherit;
                              --background-color: transparent;
                            " class="ast-builder-social-element ast-inline-flex ast-phone header-social-item"><span
                            class="ahfb-svg-iconset ast-inline-flex svg-baseline"><svg
                          ...
                          href="https://api.whatsapp.com/send?phone=+91<?= $email = get_setting('company_phone'); ?>&#038;text=Hello%20Aneesh%2C%20we%20are%20looking%20to%20connect%20with%20Navaantrix%20for%20the%20following%20...."
                          aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" style="
                              --color: #5bba67;
                              --background-color: transparent;
          ...
          <div
            ...
            <div class="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
              <div class="site-header-primary-section-left site-header-section ast-flex site-header-section-left">
                <div class="ast-builder-layout-element ast-flex site-header-focus-item" data-section="title_tagline">
                  <div>
                    <span class=""><a href="/" class="custom-logo-link" rel="home" aria-current="page"><img width="156"
                          height="62" src="<?= base_url('assets/images/Navaantrix_Logo.png')?>" class="custom-logo" alt="Navaantrix"
              ...
              <div class="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                <div class="ast-builder-layout-element ast-flex site-header-focus-item"
                  ...
                  <div class="ast-header-social-1-wrap ast-header-social-wrap">
                    <div
                      class="header-social-inner-wrap element-social-inner-wrap social-show-label-false ast-social-color-type-custom ast-social-stack-none ast-social-element-style-filled">
                      <a href="mailto:info@navaantrix.com%20" aria-label="Email" style="
                            --color: #ea4335;
                            --background-color: transparent;
                          " class="ast-builder-social-element ast-inline-flex ast-email header-social-item"><span
                          ...
                          </svg></span></a><a href="tel:+9190110%2001818%20" aria-label="Call" us style="
                            --color: inherit;
                            --background-color: transparent;
                          " class="ast-builder-social-element ast-inline-flex ast-phone header-social-item"><span
                          class="ahfb-svg-iconset ast-inline-flex svg-baseline"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        href="https://api.whatsapp.com/send?phone=9011001818&#038;text=Hello%20Aneesh%2C%20we%20are%20looking%20to%20connect%20with%20Navaantrix%20for%20the%20following%20...."
                        aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" style="
                            --color: #5bba67;
                            --background-color: transparent;
                          " class="ast-builder-social-element ast-inline-flex ast-whatsapp header-social-item"><span
                ...
                <div class="ast-builder-layout-element ast-flex site-header-focus-item"
                  ...
                  <div class="ast-button-wrap">
                    <button type="button" class="menu-toggle main-header-menu-toggle ast-mobile-menu-trigger-minimal"
                      aria-expanded="false">
                ...
                <nav class="site-navigation ast-flex-grow-1 navigation-accessibility site-header-focus-item"
                  ...
                  <div class="main-navigation">
                    <ul id="ast-hf-mobile-menu"
                      ...
                      <li
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-8 current_page_item menu-item-13">
                        <a href="<?= base_url('/') ?>" aria-current="page" class="menu-link">Home</a>
                      </li>
